    ...
    <form name="dados" action="pag/html.php" onsubmit="return this">
      <div class="album py-5 bg-light">
        <div class="container">
			...
			<p style="margin-left:42%; margin-top:-11%; text-align:justify">⠀⠀<b>JavaScript</b> é uma linguagem de programação interpretada estruturada, de script em alto nível com tipagem dinâmica fraca e multiparadigma. Juntamente com HTML e CSS, o JavaScript é uma das três principais tecnologias da World Wide Web.</p>
			<p style="margin-top:7%; font-size:22px;"><b>Vídeos de tutorial a seguir:</b></p>
		...
		<br><center><a href="css.php"><button type="button" href="css.php" class="btn btn-light btn-lg" style="background-color: #fbd601; color: white;">⠀Voltar⠀</button></a>⠀
				<a href="c.php"><button type="button" href="c.php" class="btn btn-light btn-lg" style="background-color: #fbd601; color: white;">Próximo</button></center></a>
