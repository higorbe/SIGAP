...
<head>
  ...
  <link href="./css/bootstrap.html.css" rel="stylesheet">
...
<body style="background-color: #ff5107;">
  ...
  <main>
    <section class="py-2 text-center container">
          <h1 class="fw-light;" style="font-weight: bold;">HTML</h1>
    </section>

    <form name="dados" action="pag/html.php" onsubmit="return this">
      <div class="album py-5 bg-light">
        <div class="container">
			<img src="../imgSIGAP/html.png" width=40%; height=40%>
			<p style="margin-top:3%; font-size:22px;"><b>Vídeos de tutorial a seguir:</b></p>
			<p style="margin-left:42%; margin-top:-22%; text-align:justify">⠀<b>HTML</b> é uma linguagem de marcação utilizada na construção de páginas na Web. Documentos HTML podem ser interpretados por navegadores. A tecnologia é fruto da junção entre os padrões HyTime e SGML. HyTime é um padrão para a representação estruturada de hipermídia e conteúdo baseado em tempo.</p>
			<center><iframe style= "margin-top:13%" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLUqYHcZLVa6YfYlK_rLA1Sk8doeYZJRZN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
			<br><center><a href="../index.php"><button type="button" href="../index.php" class="btn btn-light btn-lg" style="background-color: #ff5107; color: white;">⠀Voltar⠀</button></a>⠀
						<a href="css.php"><button type="button" href="css.php" class="btn btn-light btn-lg" style="background-color: #ff5107; color: white;">Próximo</button></center></a>
		</div>
      </div>
    </form>
  </main>
