    ...
    <form name="dados" action="pag/html.php" onsubmit="return this">
      <div class="album py-5 bg-light">
        <div class="container">
			...
			<p style="margin-left:42%; margin-top:-16%; text-align:justify">⠀<b>C#</b> é uma linguagem de programação, multiparadigma, de tipagem forte, desenvolvida pela Microsoft como parte da plataforma .NET. A sua sintaxe orientada a objetos foi baseada no C++ mas inclui muitas influências de outras linguagens de programação, como Object Pascal e, principalmente, Java.</p>
			<p style="margin-top:10%; font-size:22px;"><b>Vídeos de tutorial a seguir:</b></p>
		...
		<br><center><a href="c++.php"><button type="button" href="c++.php" class="btn btn-light btn-lg" style="background-color: #9b4f97; color: white;">⠀Voltar⠀</button></a>⠀
					<a href="python.php"><button type="button" href="python.php" class="btn btn-light btn-lg" style="background-color: #9b4f97; color: white;">Próximo</button></center></a>
      </div>
    </form>
  </main>
